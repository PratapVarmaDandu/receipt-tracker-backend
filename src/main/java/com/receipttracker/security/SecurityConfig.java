    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        if (isLocalProfile) {
            ...
            http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/immigration/data-requests/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/immigration/packages/questionnaires/**").permitAll()
